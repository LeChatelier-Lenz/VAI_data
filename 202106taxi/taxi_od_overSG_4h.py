...
# fhv_df = fhv_df[["pickup_datetime","PUlocationID" ,"DOlocationID"]]

green_df = pd.read_parquet("green_tripdata_2021-06.parquet")
green_df = green_df[["lpep_pickup_datetime","PULocationID" ,"DOLocationID"]]
yellow_df = pd.read_parquet("yellow_tripdata_2021-06.parquet")
yellow_df = yellow_df[["tpep_pickup_datetime","PULocationID" ,"DOLocationID"]]


taxi_zones_df = pd.read_csv("taxi_zones.csv")
taxi_zones_df = taxi_zones_df[["the_geom","LocationID"]].sort_values(by="LocationID")
# 打印出租车区域的所有LocationID
# print(taxi_zones_df["LocationID"])

# print(len(taxi_zones_df))
